...
A (non-mathematical) definition of interpretability that  I like by Miller (2017)[^Miller2017] is:
...
Interpretable machine learning is a useful umbrella term that captures the "extraction of relevant knowledge from a machine-learning model concerning relationships either contained in data or learned by the model". [^Murdoch]
...
```{r amazon-recommendation, fig.cap='Recommended products that are frequently bought together.'}
...
```{r doge-stuck, fig.cap="Doge, our vacuum cleaner, got stuck. As an explanation for the accident, Doge told us that it needs to be on an even surface."}
...
[^Murdoch]: Murdoch, W. J., Singh, C., Kumbier, K., Abbasi-Asl, R., & Yu, B.  "Definitions, methods, and applications in interpretable machine learning." Proceedings of the National Academy of Sciences, 116(44), 22071-22080. (2019).
